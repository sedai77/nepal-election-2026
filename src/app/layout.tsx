...
export const metadata: Metadata = {
  ...
  title: {
    default: "Nepal Election 2026 (चुनाव २०८२) — Interactive Map, Candidates & Results",
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: SITE_NAME,
    title: "Nepal Election 2026 (चुनाव २०८२) — Interactive Map & Candidates",
    description:
  ...
  twitter: {
    ...
    title: "Nepal Election 2026 — Interactive Map, Candidates & Results",
    description:
